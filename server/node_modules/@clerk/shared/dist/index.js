...
var fallbackTimers = () => {
  ...
  const setInterval2 = globalThis.setInterval.bind(globalThis);
  const clearTimeout2 = globalThis.clearTimeout.bind(globalThis);
  const clearInterval2 = globalThis.clearInterval.bind(globalThis);
  return { setTimeout: setTimeout2, setInterval: setInterval2, clearTimeout: clearTimeout2, clearInterval: clearInterval2, cleanup: noop };
};
var createWorkerTimers = () => {
  ...
  const clearInterval2 = (id2) => {
    init();
    callbacks.delete(id2);
    post(worker, { type: "clearInterval", id: id2 });
  };
  return { setTimeout: setTimeout2, setInterval: setInterval2, clearTimeout: clearTimeout2, clearInterval: clearInterval2, cleanup };
};
